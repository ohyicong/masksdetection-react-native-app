...
var ESMModuleProvider = /** @class */ (function () {
    ...
    ESMModuleProvider.prototype.produceCustomTFJSModule = function (config) {
        var kernels = config.kernels, backends = config.backends, forwardModeOnly = config.forwardModeOnly, outputPath = config.outputPath;
        var moduleStrs = custom_module_1.getCustomModuleString(kernels, backends, forwardModeOnly, exports.esmImportProvider);
        ...
        if (converterOps.length > 0) {
            ...
            var customConverterOpsFileName = 'custom_ops_for_converter.ts';
